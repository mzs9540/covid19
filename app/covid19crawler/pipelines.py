...
class CSVPipeline(object):
    ...
    def open_spider(self, spider):
        ...
        self.exporter.fields_to_export = ['countries', 'total_recovered', 'active_cases',
                                          'total_cases_per_million', 'death_per_million',
                                          'new_cases', 'total_cases', 'total_deaths', 'new_deaths']
        self.exporter1.fields_to_export = ['new_cases', 'total_cases', 'total_deaths', 'new_deaths']
